...
public class P13_PaymentInformationPage {
    WebDriver driver;
    public P13_PaymentInformationPage(WebDriver driver){
        this.driver=driver;
    }
    ...
    public P13_PaymentInformationPage fillCardHolderName(String holderName){
    ...
    public P13_PaymentInformationPage fillCreditCardNumberField(String creditNumber){
    ...
    public P13_PaymentInformationPage selectExpireYear(int index){
    ...
    public P13_PaymentInformationPage fillCardCode(String cardCode){
    ...
    public P13_PaymentInformationPage clickOnContinueAtPaymentInfoSec(){
        try {
