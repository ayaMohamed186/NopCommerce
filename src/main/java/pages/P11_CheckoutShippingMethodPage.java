...
public class P11_CheckoutShippingMethodPage {
    WebDriver driver;

    public P11_CheckoutShippingMethodPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public P11_CheckoutShippingMethodPage selectGroundShippingMethod() {
    ...
    public P11_CheckoutShippingMethodPage clickOnContinueBtnAtShippingMethod() {
        try {
